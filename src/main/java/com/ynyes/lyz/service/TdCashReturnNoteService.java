...
/**
 * <p>标题：TdCashReturnNoteService.java</p>
 * <p>描述：用户退款单据服务类</p>
...
public class TdCashReturnNoteService {
	 ...
	 */
	public List<TdCashReturnNote> findByUsernameAndIsOperatedOrderByCreateTimeDesc(String username,Boolean isOperated){
	 ...
	 */
	public Page<TdCashReturnNote> findByUsernameAndIsOperatedOrderByCreateTimeDesc(String username,Boolean isOperated,int page,int size){
		if(null == username || null == isOperated){
			return null;
		}
		PageRequest pageRequest = new PageRequest(page, size);
