...
public class TdDeposit {
	...
	public String toString() {
		return "TdDeposit [id=" + id + ", username=" + username + ", userId=" + userId + ", money=" + money
				+ ", isAgree=" + isAgree + ", isRemit=" + isRemit + ", createTime=" + createTime + ", agreeTime="
				+ agreeTime + ", remitTime=" + remitTime + ", reason=" + reason + ", remark=" + remark + "]";
	}
}
