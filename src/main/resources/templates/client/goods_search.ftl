...
<html>
    ...
    <body style="background: #f3f4f6;height: 100%;">
        <div>
            ...
            <div class="go_buy">
                <a style="background:#ffaa00;width:50%;" style="background:#ffaa00;" href="javascript:addCart();">加入已选</a>
                <p style="width: 50%;" onclick="window.location.href='/user/selected'">查看已选(<span id="select_num">${selected_number!'0'}</span>)</p>
